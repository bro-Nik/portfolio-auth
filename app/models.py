...
class User(Base):
    ...
    role: Mapped[UserRole] = mapped_column(String, default=UserRole.USER.value, nullable=False)
    ...
    total_active_time: Mapped[int] = mapped_column(Integer, default=0, nullable=False)  # Общее время на сайте в секундах
